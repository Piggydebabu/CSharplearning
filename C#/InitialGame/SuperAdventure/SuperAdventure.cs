        ...
        private void MoveTo(Location newLocation)
        {
            ...
            if (newLocation.MissionAvailableHere != null)
            {
                ...
                if (playerAlreadyHasMission)
                {
                    ...
                    if (!playerAlreadyCompletedMission)
                    {
                        ...
                        bool playerHasAllItemsToCompleteMission = _player.HasAllMissionCompleteItems(newLocation.MissionAvailableHere);
                        ...
                        if (playerHasAllItemsToCompleteMission)
                        {
                            ...
                            rtbMessages.Text += "You complete the '" + newLocation.MissionAvailableHere.Name + "' quest." + Environment.NewLine;

                            // Remove quest items from inventory
                            _player.RemoveMissionCompleteItems(newLocation.MissionAvailableHere);

                            // Give quest rewards
                            rtbMessages.Text += "You receive: " + Environment.NewLine;
                            rtbMessages.Text += newLocation.MissionAvailableHere.RewardExpPoints.ToString() + " experience points" + Environment.NewLine;
                            rtbMessages.Text += newLocation.MissionAvailableHere.RewardGold.ToString() + " gold" + Environment.NewLine;
                            rtbMessages.Text += newLocation.MissionAvailableHere.RewardItem.Name + Environment.NewLine;
                            rtbMessages.Text += Environment.NewLine;

                            _player.ExpPoints += newLocation.MissionAvailableHere.RewardExpPoints;
                ...
                else
                {
                    ...
                    rtbMessages.Text += "You receive the " + newLocation.MissionAvailableHere.Name + " quest." + Environment.NewLine;
                    rtbMessages.Text += newLocation.MissionAvailableHere.Description + Environment.NewLine;
                    rtbMessages.Text += "To complete it, return with:" + Environment.NewLine;
                    foreach (MissionCompleteItem qci in newLocation.MissionAvailableHere.MissionCompleteItems)
                    {
                        if (qci.Quantity == 1)
                        {
            ...
            if (newLocation.MonsterLivingHere != null)
            {
                ...
                _currentMonster = new Monster(standardMonster.ID, standardMonster.Name, standardMonster.MaximumDamage,
                    standardMonster.RewardExpPoints, standardMonster.RewardGold, standardMonster.CurrentHitPoints, standardMonster.MaximumHitPoints);
